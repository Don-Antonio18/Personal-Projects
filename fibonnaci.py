...
def fibonacci(n,  dictionary ={}): #creates python dictionary 
	n = int(n)
	if n in dictionary: #checks to see if n index is in dictionary
		return dictionary[n] #code returns current index of n 
	if n == 0:
		return 0
	elif n == 1:
		return 1
	else:
		#code adds new values into dictionary
